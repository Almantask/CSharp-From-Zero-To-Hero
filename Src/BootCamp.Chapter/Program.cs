...
namespace BootCamp.Chapter
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //First person convert cm to m for BMI
            float heightM1 = heightCm1/100;

            //First person BMI (body-mass index) calculator
            ...
            //Second person convert cm to m for BMI
            float heightM2 = heightCm2 / 100;

            //Second person BMI (body-mass index) calculator
