...
namespace BootCamp.Chapter
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // End.
            Console.WriteLine("\n");
            Console.WriteLine("Judging by our calculations, we have come to the conclusion that both users are not within the healthy range of the self-confidence crusher BMI Calculator.");
